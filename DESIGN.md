...
**A Regra do Anel que Compõe.** O anel colorido foi recusado por este sistema durante toda a sua vida, e a razão era honesta: uma rosca precisa de uma cor por fatia, e não havia paleta. Agora há — validada, fechada em oito, com legenda obrigatória ao lado. Ele vale só para **parte-do-todo**, que é a composição das despesas do mês em Orçamento; "qual categoria pesou mais" continua em barras no painel, porque comparar comprimento é mais fácil que comparar ângulo. Duas formas para duas perguntas, nunca duas formas para a mesma. Entre fatias há sempre um vão de superfície: sem ele, duas categorias de matiz vizinho viram uma mancha só e a contagem de fatias se perde.
